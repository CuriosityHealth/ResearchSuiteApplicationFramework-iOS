...
//W
public typealias RSDashboardCellGenerator = (Store<RSState>, RSState, UIViewController, UICollectionView, RSCollectionViewCellManager, RSDashboardAdaptorItem, IndexPath) -> RSCollectionViewCell?
